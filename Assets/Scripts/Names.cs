public static class Names
{
    ...
    public static string FeedbackMessage = "Message";

    public static string ConnectingMessage = "Connecting Neurosky Device...";

    public static string SocketConnectionMessage = "Neurosky Device is not connected";

    public static string NeuroskyStatsText = "NeuroskyStats";
